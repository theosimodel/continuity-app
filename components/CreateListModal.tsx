...
import { X, Lock, Link, Globe } from 'lucide-react';
...
const CreateListModal: React.FC<CreateListModalProps> = ({ isOpen, onClose, onSave, editList }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className="bg-[#161A21] rounded-xl w-full max-w-md border border-[#1E232B]">
        ...
        <div className="flex gap-3 p-6 border-t border-[#1E232B]">
          <button
            onClick={onClose}
